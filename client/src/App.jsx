  ...
  useEffect(() => {
    if (!loading) {
      fetch('http://localhost:5000/')
        .then(res => res.text())
        .then(msg => console.log('Backend Status:', msg))
        .catch(err => console.warn('Backend currently offline.'));
    }
  }, [loading]);
    ...
    <div className="app-container">
      ...
      <header className="hero">
        <div className="hero-content">
          ...
          <div className={`hero-title-reveal ${heroRevealed ? 'active' : ''}`}>
            <span className="college-name">DMI ENGINEERING COLLEGE</span>
            <h1>COLLEGE DAY</h1>
            <h2 className="sub-title">& SPORTS FEST 2026</h2>
          </div>
      ...
      <section className="section stats-section">
        <div className="stats-grid">
          {[
            { value: '3+', label: 'Mega Events' },
            { value: '1000+', label: 'Student Participants' },
            { value: '50+', label: 'Student Volunteers' },
      ...
      <section id="gallery" className="section">
        ...
        <div className="gallery-grid">
          {[sportsImg, foodImg, culturalImg, sports2Img, food2Img, cultural2Img].map((img, i) => (
